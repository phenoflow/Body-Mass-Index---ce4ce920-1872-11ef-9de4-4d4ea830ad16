...
steps:
  ...
  normal-body-mass-index---primary:
    run: normal-body-mass-index---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  clinic-body-mass-index---primary:
    run: clinic-body-mass-index---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: normal-body-mass-index---primary/output
  body-mass-index-recorded---primary:
    run: body-mass-index-recorded---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: clinic-body-mass-index---primary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: body-mass-index-recorded---primary/output
class: Workflow
inputs:
  potentialCases:
    id: potentialCases
